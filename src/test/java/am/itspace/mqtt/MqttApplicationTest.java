...
public class MqttApplicationTest {
    ...
    private static Logger log = LoggerFactory.getLogger(MqttApplicationTest.class);
    ...
    public void whenSendSingleMessage_thenSuccess() throws Exception {
        ...
        subscriber.subscribe(MqttApplication.TOPIC, (topic, msg) -> {
        ...
        Callable<Void> target = new MqttApplication(publisher);
        target.call();
